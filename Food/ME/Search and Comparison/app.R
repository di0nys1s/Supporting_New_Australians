...
server = function(input, output, session){
  ...
  observeEvent(input$pop_up, {
    # Hey John! Please edit here
    # pop up info
    shinyalert("What are details?",
               paste(
                 'Customer Size: The ratio of population/number of existing business',
                 '\n',
                 '\n',
                 'Income Level: Weekly household income of a suburb',
                 '\n',
                 '\n',
                 'Low - $0 to $743',
                 '\n',
                 'Medium Low - $744 to $1,431',
                 '\n',
                 'Medium High - $,432 to $,433',
                 '\n',
                 'High - $2,434 +'))
  })
